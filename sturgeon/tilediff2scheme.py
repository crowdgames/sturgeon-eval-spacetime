...
def tilediff2scheme(tile_info, scheme_info, offset_row, context_delta, games):
    ti = tile_info
    ...
    si.pattern_info.dr_hi = 0#offset_row
...
if __name__ == '__main__':
    ...
    parser.add_argument('--schemefile', type=str, help='Scheme file to add to.')
    ...
    if args.schemefile is not None:
    ...
    scheme_info = tilediff2scheme(tile_info, scheme_info, args.diff_offset_row, context, args.game)
