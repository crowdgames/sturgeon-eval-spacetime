...
python app_pathed.py --outfile work/mario-1-1_ti --schemefile work/mario-1-1_ti.scheme --pattern-hard --count-soft --size 14 21 --reach-move platform --reach-start-goal all --app --test
...
python app_pathed.py --outfile work/cave_ti --schemefile work/cave_ti.scheme --pattern-hard --count-soft --size 10 10 --reach-move maze --reach-start-goal all --app --test
python app_pathed.py --outfile work/cave_ti --schemefile work/cave_ti.scheme --pattern-hard --count-soft --size 10 10 --reach-move tomb --reach-start-goal all --app --test
...
python app_pathed.py --outfile work/wrap-maze_ti --schemefile work/wrap-maze_ti.scheme --size 9 6 --reach-move maze --reach-start-goal all --reach-wrap-rows --reach-wrap-cols --app --test
