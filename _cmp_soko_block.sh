...
python sturgeon/input2tile.py --outfile _out/cmp/soko/block/setup_ts.tileset --out-tileset --textfile _out/cmp/soko/block/in_*.lvl

# make tile and scheme files for each height

python sturgeon/input2tile.py --outfile _out/cmp/soko/block/setup_7x.tile --textfile _out/cmp/soko/block/in_*_7x.lvl --tileset _out/cmp/soko/block/setup_ts.tileset
python sturgeon/input2tile.py --outfile _out/cmp/soko/block/setup_8x.tile --textfile _out/cmp/soko/block/in_*_8x.lvl --tileset _out/cmp/soko/block/setup_ts.tileset

python sturgeon/tile2scheme.py --outfile _out/cmp/soko/block/setup_7x.scheme --tilefile _out/cmp/soko/block/setup_7x.tile --pattern block-rst-noout,3,3,2,9
python sturgeon/tile2scheme.py --outfile _out/cmp/soko/block/setup_8x.scheme --tilefile _out/cmp/soko/block/setup_8x.tile --pattern block-rst-noout,3,3,2,10

# remap scheme files to output height and merge

python sturgeon/scheme2merge.py --outfile _out/cmp/soko/block/setup_6x-A.scheme --schemefile _out/cmp/soko/block/setup_7x.scheme --remap-row "0,2=0" "9,11=-1"
python sturgeon/scheme2merge.py --outfile _out/cmp/soko/block/setup_6x-B.scheme --schemefile _out/cmp/soko/block/setup_8x.scheme --remap-row "0,2=0" "10,12=-2"
python sturgeon/scheme2merge.py --outfile _out/cmp/soko/block/setup_6x.scheme --schemefile _out/cmp/soko/block/setup_6x-A.scheme _out/cmp/soko/block/setup_6x-B.scheme --remove-void

# create tag file and text constraint

python sturgeon/level2concat.py --outfile _out/cmp/soko/block/setup_6x6x7.tag --pad-between 2 --size 6 6 --term-inst 7
python sturgeon/level2concat.py --outfile _out/cmp/soko/block/setup_6x6x7.lvl --pad-between 2 --size 4 4 --term-inst 6 --pad-around _ --pad-end T

# generate levels

for ii in `seq -f '%02g' 0 $((${count}-1))`; do
    python sturgeon/scheme2output.py --outfile _out/cmp/soko/block/out_${ii} \
